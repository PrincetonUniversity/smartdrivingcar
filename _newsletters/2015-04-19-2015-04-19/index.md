...
title: "2015-04-19"
date: 2015-04-19
permalink: /2015-04-19-2015-04-19/
---
...
## [New York City Taxicab Transportation Demand Modeling for the Analysis of Ridesharing and Autonomous Taxi Systems (Draft)](http://orfe.princeton.edu/%7Ealaink/Theses/SeniorTheses%2715/AJSwoboda--NYC_aTaxiRideSharingPotential2015.pdf)
...
## [Truly Empty Vehicle Repositioning and Fleet-Sizing: Optimal Management of an Autonomous Taxi System in New Jersey on a Typical Weekday](http://orfe.princeton.edu/%7Ealaink/Theses/SeniorTheses%2715/KylDouglas-ATaxiEmptyRepositioning2015.pdf)

Kyle Douglas '15 April 2015 "The thesis outlines a series of naive empty vehicle repositioning and fleet-sizing policies before providing a formal and detailed mathematical model for the empty vehicle repositioning problem specific to an autonomous taxi system. It then provides policies for empty vehicle repositioning and fleet-sizing based on the model. [Read more](http://orfe.princeton.edu/%7Ealaink/Theses/SeniorTheses%2715/KylDouglas-ATaxiEmptyRepositioning2015.pdf)

## [Self-driving cars? Pah! How about just meeting basic safety standards first?](http://motorburn.com/2015/04/self-driving-cars-pah-just-meeting-basic-safety-standards-first/)

By Ryan Bubear: Columnist on 16 April, 2015 "...Of more immediate concern is the shockingly low level of basic safety still displayed by so many of today's cars on sale in low-income markets. Indeed, a recent Global NCAP report revealed just how worrying things are, with chairperson Max Mosley stating that "crash test standards introduced twenty years ago for cars sold in Europe are yet to be met by many new cars, and even brand new models, being sold today in leading middle-income countries in Africa, Asia, and Latin America"...." [Read more](http://motorburn.com/2015/04/self-driving-cars-pah-just-meeting-basic-safety-standards-first/) Absolutely!! Even worse in trucks and buses. Alain

## [How Will Attorneys (or any of us) Adapt?](http://www.workerscompensation.com/compnewsnetwork/workers-comp-blogwire/21183-how-will-attorneys-or-any-of-us-adapt.html)

Judge David Langham 04/16/2015 "... If software decreases the need for attorneys, is there a marked effect on non-lawyers? If a hamburger churning machine replaces three employees at the local fast food joint, is there a significance to the consumer? ..." [Read more](http://www.workerscompensation.com/compnewsnetwork/workers-comp-blogwire/21183-how-will-attorneys-or-any-of-us-adapt.html) Surprised that I included this one. Attorneys Adapt??? :-) Alain

## [Watch: Audi's self-driving car in action](http://www.telegraph.co.uk/motoring/motoringvideo/11545952/Watch-Audis-self-driving-car-in-action.html)

Alex Robbin 18 Apr 2015 The self-driving version of the Audi A7 Sportback is only a prototype at the moment, and there are numerous legal issues to be overcome before it can go on sale. However, the technology feels remarkably close to being production ready. In fact, the car is so competent at changing lanes and accelerating and braking as needed that it isn't long before I feel completely comfortable taking my eyes off the road. [Read more](http://www.telegraph.co.uk/motoring/motoringvideo/11545952/Watch-Audis-self-driving-car-in-action.html) Just watch the video and the comments by the driver Alain
...
I love it! Maybe I should do an "Uber" soliciting the participation of [recreational pilots](http://en.wikipedia.org/wiki/Pilot_certification_in_the_United_States) in preparation for the aPlane market. ;-) Prof. K.

### [Why Pilots Still Matter](http://www.nytimes.com/2015/04/10/opinion/why-pilots-still-matter.html?&assetType=opinion)

Patrick Smith, April 10, 2015 "...The automation only does what we tell it to do. On the 767 that I fly, there are multiple ways to set up and command any routine climb, descent or change of course. Meanwhile, more than 99 percent of landings, and a full 100 percent of takeoffs, are performed manually..." [Read more](http://www.nytimes.com/2015/04/10/opinion/why-pilots-still-matter.html?&assetType=opinion)

### [Airplane! (2/10) Movie CLIP - Automatic Pilot (1980) HD](https://www.youtube.com/watch?v=rQbj9uvYL8I)

### [The 4 Best Stocks to Invest in Autonomous Driving](http://m.fool.com/investing/general/2015/04/16/the-4-best-stocks-to-invest-in-autonomous-driving)

Sam Mattera - April 16, 2015 "...For investors, the upside could be equally as impressive. Although the industry remains in its early days, several companies are poised to take advantage of the shift. Below are four stocks that offer exposure to the coming autonomous car revolution.... [Read more](http://m.fool.com/investing/general/2015/04/16/the-4-best-stocks-to-invest-in-autonomous-driving)

Hmmm... the no-brainers! Alain

## Recompiled Old News:

### [Deep learning could help safely automate cars](http://articles.sae.org/13996/)
...
Deep learning lets machines program themselves to classify objects. In automotive systems, deep learning can be used to create a database of images and actions to be taken given their position in relation to the vehicle. [Read more](http://articles.sae.org/13996/) Hmmm... Certainly one of the approaches we're researching. See also: [Towards Deep Neural Network Architectures Robust to Adversarial Examples](http://arxiv.org/abs/1412.5068) Alain

## Half-baked stuff that probably doesn't deserve your time:

### [Auto Analyst: The Remainder of My Career Will Be Focused on This One Chart](http://www.bloomberg.com/news/articles/2015-04-07/auto-analyst-the-remainder-of-my-career-will-be-focused-on-this-one-chart)

"...Morgan Stanley Analyst Adam Jonas says this chart is so important that you need to put it on your wall. .."

[Read More](http://www.bloomberg.com/news/articles/2015-04-07/auto-analyst-the-remainder-of-my-career-will-be-focused-on-this-one-chart) Hmmm... The Human-Autonomous vs. Owned-Shared chart is a good way to imagine the evolution of from where we are now to where we might end up; however, I disagree with Jonas' characterization of this 2-D space.
...
3. To go beyond today in the upper right hand quadrant requires driverless with high scope; neither of which can evolve from the lower right or the upper-left quadrants any better than directly from the lower left. Achievement of the upper right requires not only the technology (wide scope driverless) but also the economic advantage of elimination of the labor cost (properly stated in the [Morgan-Stanley report](http://orfe.princeton.edu/%7Ealaink/SmartDrivingCars/PDFs/MorganStanley%20040715ReportJonas.pdf) but, which Uber, etc. can't demonstrate, even if they prey on the most disadvantaged in our society). Alain

### [The Connected Car Faces Its First Class Action Lawsuit](http://www.forbes.com/sites/dougnewcomb/2015/03/31/the-connected-car-faces-its-first-class-action-law-suit/?utm_campaign=cmp_411778&utm_medium=email&utm_source=getanewsletter)

Doug Newcomb 3/31/15 "Connected car technology faces no shortages of potential roadblocks, including industry standardization, data management, consumer acceptance and government regulation, just to name a few. Central among these are legal issues confronting not only automakers currently building and selling connected cars, but all stakeholders – automotive suppliers, technology providers and also government officials – involved and that view significant benefits to connecting cars to each other and to traffic infrastructure to reduce traffic, fuel consumption, emissions and, most importantly, the number of lives lost in car accidents...." [Read more](http://www.forbes.com/sites/dougnewcomb/2015/03/31/the-connected-car-faces-its-first-class-action-law-suit/?utm_campaign=cmp_411778&utm_medium=email&utm_source=getanewsletter)

### [Researchers Hack Into Driverless Car System, Take Control of Vehicle](http://www.nationaldefensemagazine.org/archive/2015/May/Pages/ResearchersHackIntoDriverlessCarSystemTakeControlofVehicle.aspx)

May 2015 Allyson Versprille "A group of Virginia-based researchers funded by the Defense Department found that it is relatively easy to remotely hack into a driverless car's control system, but said hardening against such an attack can be inexpensive...." [Read more](http://www.nationaldefensemagazine.org/archive/2015/May/Pages/ResearchersHackIntoDriverlessCarSystemTakeControlofVehicle.aspx) Hmmm... I can also break a display window at Tiffany's and grab the diamonds or drop a bowling ball from an overpass and hit a passing car below but it doesn't mean that I'm going to do it.
...
### [NASA made an autonomous car too, and it makes Google's look dull](http://www.slashgear.com/nasa-made-an-autonomous-car-too-and-it-makes-googles-look-dull-13378848/)

Apr 13, 2015 "Today the space agency decided to show the fruits of its labor, however, posting a [video on its YouTube](https://www.youtube.com/watch?feature=player_embedded&v=f-VUHdmjytM) account of the finished product. It is called the Modular Robotic Vehicle, MRV for short, and it can -- among other things -- drive itself when needed...." [Read more](http://www.slashgear.com/nasa-made-an-autonomous-car-too-and-it-makes-googles-look-dull-13378848/) Hmmmm... well maybe? They've done the remote control actuator part, but have they done the environmental sensor and intelligence part? Easy part done; hard part yet to tackle? Alain

### [Driverless cars, robot surgeons drive Nokia-Alcatel merger](http://www.therecord.com/news-story/5562473-driverless-cars-robot-surgeons-drive-nokia-alcatel-merger/)

Matt Campbell 4/16/15 "...Nokia's $16.6-billion takeover of Alcatel-Lucent will create a leader in building networks for today's smartphones. The companies are betting they can also get an edge connecting millions of intelligent machines that haven't been invented yet...." [Read more](http://www.therecord.com/news-story/5562473-driverless-cars-robot-surgeons-drive-nokia-alcatel-merger/) Hmmm... Is this another bad call by Nokia? Driverless cars will allow the Nokia-Alcatel bandwidth to be consumed, but it will do precious little to enable driverless mobility. Alain

## [C'mon Man!](https://www.youtube.com/watch?v=A7SwSd59E4I) (These folks didn't get/read the memo)

Hmmm... [C'Mon Man!](https://www.youtube.com/watch?v=A7SwSd59E4I)

## Calendar of Upcoming Events:

## [Webinar](https://webmeeting.umd.edu/atraigwebinar/)

## April 22, 15:00 GMT

[What to plan for when planning for Automated Transit Networks](https://webmeeting.umd.edu/atraigwebinar/)
...
communication, as well as liberating a chunk of the 700 MHz radio spectrum so the test cars can talk back and forth. The project is expected to get underway later this year...." [Read more](http://www.gizmag.com/germany-self-driving-car-public-test/35806/) This is interesting. Alain  
January 29, 2015
