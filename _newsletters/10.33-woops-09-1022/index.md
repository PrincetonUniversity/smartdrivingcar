...
date: 2022-02-09
permalink: /10.33-woops-09-1022/
display_name: "10.33 - Woops 09 1022"
---
33rd edition of the 10th year of SmartDrivingCars eLetter

### [Self-Driving Tech Company Floats Possible Sale to Apple or Microsoft](https://www.bloomberg.com/news/articles/2022-09-02/self-driving-ceo-floats-possible-sale-to-apple-or-microsoft?leadSource=uverify wall)
...
Chris Urmson, who co-founded Aurora after running Google's self-driving car project, also outlined cost cuts and floated measures including taking the company private, spinning off or selling assets and pursuing a small capital raise in a memo labeled "board discussion pre-read" and dated Aug. 3. Urmson inadvertently sent this to staff and asked them on Aug. 9 not to open it, the document shows.  ..." [Read more](https://www.bloomberg.com/news/articles/2022-09-02/self-driving-ceo-floats-possible-sale-to-apple-or-microsoft?leadSource=uverify wall) Hmmmm... Realistic but not good news. With revenue at zero all of these companies are struggling. The annual addressable market of new class 8 trucks in the US is about 275,000 units. Given the large number of competitors addressing a limited market that has yet to yield any revenue for any of them suggests that this is a really tough business, especially if first revenue remains a year or more in the future.
...
### [The Design & Simulation Conference for the Era of AI and the Metaverse](https://www.nvidia.com/gtc/)

Free virtual developer conference with outstanding AV content. September 19->22,

* [Keynote](https://www.nvidia.com/gtc/session-catalog/?tab.catalogallsessionstab=16566177511100015Kus#/session/1657326563846001zRzJ)

* [AV Sessions](https://www.nvidia.com/gtc/session-catalog/?tab.catalogallsessionstab=16566177511100015Kus&search=Automotive#/)

* [Registration.. Free!](https://register.nvidia.com/flow/nvidia/gtcfall2022/attendeeportal/page/sessioncatalog)

* [Super Star Lineup](https://s3.amazonaws.com/cms.ipressroom.com/219/files/20227/202208151726/top-speakers-at-gtc22-thumbnail.jpg)

[Read more](https://www.nvidia.com/gtc/) Lots of really good sessions.  Join in. Alain

### [MIT Mobility Forum](https://www.mobilityinitiative.mit.edu/mobilityforum)

Fall 2022 , "The MIT Mobility Forum showcases the groundbreaking transportation research occurring across the Institute. Faculty members and researchers present their latest findings, ideas, and innovations, followed by a lively discussion. The Forum is online and open to all. [Please register at Zoom](https://mit.zoom.us/meeting/register/tJctcOGgrz8uHtYPiPHkEZHWW5XfBjR7fZJx) beforehand. " [Read more](https://www.mobilityinitiative.mit.edu/mobilityforum) An Absolutely excellent lineup, every Friday, starting Sept. 16th with Prof. [Susan Handy'84](https://susanhandy.ucdavis.edu/), UC Davis.  Alain

### [MOBILEYE STARTS TESTING LEVEL 4 AUTONOMOUS DRIVING IN DETROIT WITH OVER 50 NIO ES8S](https://eletric-vehicles.com/nio/mobileye-starts-testing-level-4-autonomous-driving-in-detroit-with-over-50-nio-es8s/)

C. Afonso, Sept 9, "The Autonomous Driving company Mobileye announced on Thursday that started testing its program of the Level 4 Self-Driving solution in Detroit with over 50 NIO ES8s. The company added that the model will form the basis of the robotaxi services that are being prepared to roll out "in the coming months" with their partners in Germany and Israel.
...
"Our Detroit testing of Mobileye Drive is helping us ensure that the system can bring forward the global commercialization of autonomous driving technology and deliver on its promise to vastly improve road safety," said Johann "JJ" Jungwirth, Senior Vice President of Autonomous Vehicles at Mobileye."... "    [Read more](https://eletric-vehicles.com/nio/mobileye-starts-testing-level-4-autonomous-driving-in-detroit-with-over-50-nio-es8s/) Hmmmm... Congratulations JJ !  Great that you are doing it in Detroit.  You can improve the lives of many with this initiative.  We'd love to have you do the same in New Jersey.  Nice complement to your [AV Shuttle](https://www.robotics247.com/article/mobileye_beep_benteler_ev_systems_develop_autonomous_shuttle_buses_2024) initiative. Alain

### [Why self-driving cars have stalled](Read more Hmmmm...)

The Guardian, Sept. 8, "Fully fledged self-driving technology appears to be perpetually just around the corner. It is a promise that the Tesla chief executive, Elon Musk, has made almost every year since 2013....

But in the real world, it is still an open question whether level five self-driving automation is actually possible. Josh Toussaint-Strauss finds out how close industry frontrunners have come to full automation and assess the scale of the problems standing in their way...." [Read more](Read more Hmmmm...) Hmmmm... A good video highlighting the challenges of trying to do Self-driving all the time, everywhere.  I claim that it is silly to try to do anything all the time, everywhere. Consequently, an easy video to produce.

Self-driving "all the time, everywhere" hasn't stalled.  Its always been and will always be a pipe dream.  (I've never been able to drive my own car "all the time, everywhere" even though Madison Avenue has forever suggested that I can  (or should be able to if I wasn't such a ... ))

Self-driving doesn't need to be "all the time and everywhere" because there is a driver in the car.  Let them do the driving at times and places where the system doesn't work very well.  In fact, more should be done to not allow them to drive either in heavy snow, torrential downpours, dense fog, when they are tired, when they've had too much to drink, smoke or snort.

We need to get to a point at which Driverless (Self-driving in an Operational Design Domain (ODD)) actually delivers safe origin to destination mobility in some ODD that delivers real value to society. Let's define the ODDs where this technology does work.  Put it to work there and begin recouping some value from all of the sunk investment.  Then focus on the most efficient and effective way to grow the ODDs such that they most expeditiously generate the most value to society. Alain

### [Tesla scores partial success in German authority's Autopilot probe: report](https://www.teslarati.com/tesla-autopilot-probe-germany-kba-results-update/)

S. Alvarez, Sept. 9. "The KBA issued criticisms for several of Autopilot's features in its earlier assessments. Among these were Autopilot's automatic lane change capabilities, which may not be permitted in Europe. The KBA also complained that Tesla unlocks some functions of its vehicles if drivers achieve a certain number of points. As noted in a report from WirtschaftsWoche business weekly, the KBA believes that vehicles must be safe enough so that all their features can be operated by all drivers.

The KBA's complaints about unlocked features and a driver's points are quite interesting, as such a system is not used by Tesla for basic Autopilot and Enhanced Autopilot features. ..."  [Read more](https://www.teslarati.com/tesla-autopilot-probe-germany-kba-results-update/) Hmmmm...  No comment.  Alain

### [GM startup Cruise recalls and revises self-driving software after crash](https://www.reuters.com/business/autos-transportation/gms-cruise-recalls-revises-self-driving-software-after-crash-2022-09-01/)

D. Shepardson, Sept 1, "A Cruise self-driving car, which is owned by General Motors Corp, is seen outside the company's headquarters in San Francisco where it does most of its testing, in California, U.S., September 26, 2018. Picture taken on September 26, 2018. REUTERS/Heather Somerville/File Photo
...
Federal regulators said the recalled software could "incorrectly predict" an oncoming vehicle's path. Cruise said it had determined this unusual scenario would not recur after the update..." [Read more](https://www.reuters.com/business/autos-transportation/gms-cruise-recalls-revises-self-driving-software-after-crash-2022-09-01/) Hmmmm.. Read the [Part 573 Safety Recall Report 22E-072](chrome-extension://efaidnbmnnnibpcajpcglclefindmkaj/https://static.nhtsa.gov/odi/rcl/2022/RCLRPT-22E072-8020.PDF) None of this is easy (but over-the-air updating of software makes it readily doable😁).  Alain

### [GM's BrightDrop eyes future self-driving EV delivery trucks](https://www.freep.com/story/money/cars/general-motors/2022/09/09/gms-brightdrop-autonomous-self-driving/67029880007/)

J. LaReau, Sept. 9, "General Motors' subsidiary, BrightDrop, will offer self-driving electric commercial delivery vehicles in the future.
...
But BrightDrop spokesman Daniel Roberts said Friday the company has no immediate plans to offer self-driving vehicles...."  [Read more](https://www.freep.com/story/money/cars/general-motors/2022/09/09/gms-brightdrop-autonomous-self-driving/67029880007/) Hmmmm... The future in not immediate @ BrightDrop.  Click Bait!  Alain

### [Uber partners with Nuro in push for autonomous food, grocery delivery](https://www.reuters.com/technology/uber-partners-with-nuro-push-autonomous-food-grocery-delivery-2022-09-08/)

Staff, Sept 8, " Uber Technologies Inc (UBER.N) said on Thursday it has partnered with start-up Nuro to test food delivery via unmanned vehicles in some U.S. locations, expanding its tie-ups with companies focused on building self-driving machines.

Last-mile autonomous delivery has emerged as a focus area for companies as consumers have stuck to ordering meals online from the comfort of their homes even after lifting of COVID-19 lockdowns...." [Read more](https://www.reuters.com/technology/uber-partners-with-nuro-push-autonomous-food-grocery-delivery-2022-09-08/) Hmmmm... Nuro does the work and Uber brings the customer.  OK. Alain

### [EV Makers Lucid, Nikola Plan for Stock Sales as Time Runs Out on Cash Burn](https://www.bloomberg.com/news/articles/2022-08-30/ev-makers-plan-for-stock-sales-as-time-runs-out-on-cash-burn?leadSource=uverify wall)

D. Singer, Aug. 30, "It was probably a case of now or never for the the latest pair of electric vehicle makers to announce fundraising plans as they burn through cash. ..."  [Read more](https://www.bloomberg.com/news/articles/2022-08-30/ev-makers-plan-for-stock-sales-as-time-runs-out-on-cash-burn?leadSource=uverify wall) Hmmmm... They still exist??? Alain
...
I can readily envision the extension of [Autonomy](https://www.autonomy.com/)'s DiY/MaaSS to MOVES/MaaS where "MOVESMobility, Inc." places a $n.m Billion RoboTaxi order with Tesla, (and/or GM, Toyota, VW, Benteler, Zoox, Baidu, Alibaba, AutoX, ...) to deploy safe, equitable, affordable, sustainable, high-quality mobility for all 24/7/350+ throughout Trenton, Perth Amboy, Patterson, Newark, Camden, Atlantic City, Edison, New Brunswick, Scranton, Greenville, Newburg, Brooklyn, Queens, Staten Island, .. and their environs' Operational Design Domains (ODD).  😁 Alain

### [Tesla's 2022 Shareholder Meeting with Elon Musk](https://www.youtube.com/watch?v=s_2BU8vqbos)

E. Musk, Aug. 4, ."

[Read more](https://youtu.be/s_2BU8vqbos?t=3500) Hmmmm... Watch the Q & A portion starting about an hour in from the start.  Watch especially the comments about his vision of the Tesla RoboTaxi (aka driverless cars, what I prefer to call autonomous Taxis or a Taxis, the new "Modern Transit").  The key visions are:
