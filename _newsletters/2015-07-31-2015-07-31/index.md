...
## [Hacked Jeep: Whom to Blame?](http://www.eetimes.com/document.asp?doc_id=1327266)
...
"The proportion of truck fleets with AEB, however, is negligible," says Peter Shaw, Chief Executive of Thatcham Research, which has led the way in the UK for testing AEB on cars. "The Commission's ruling to make it mandatory has spurred the industry to catch up, but it will be many years before the UK's fleet of 500,000 HGVs are all equipped with this level of safety..." [Read more](http://www.thatcham.org/news-and-events/news-and-press-releases-reader/items/auto-braking-hgvs-to-catch-up-with-cars?utm_campaign=5959280_Stop+the+Crash+July&utm_medium=email&utm_source=Thatcham+Research&dm_i=21KA,3JQ7K,KMXMUS,CQ2P2,1)
...
## [BVRLA calls for emergency braking action as safety rises up fleet agenda](http://www.fleetnews.co.uk/fleet-leasing/news/latest-fleet-leasing/2015/07/15/bvrla-calls-for-emergency-braking-action-as-safety-rises-up-fleet-agenda?utm_campaign=5959280_Stop+the+Crash+July&utm_medium=email&utm_source=Thatcham+Research)
...
Gerry Keaney, chief executive of the British Vehicle Rental and Leasing Association (BVRLA), said: "2014 was the first time in 18 years that the number of casualties on the roads in the UK increased." "That should be a signal to everybody that these things do not take care of themselves automatically.... "[Read more](http://www.fleetnews.co.uk/fleet-leasing/news/latest-fleet-leasing/2015/07/15/bvrla-calls-for-emergency-braking-action-as-safety-rises-up-fleet-agenda?utm_campaign=5959280_Stop+the+Crash+July&utm_medium=email&utm_source=Thatcham+Research) Hmmm... Go UK!!! Alain

### [Local government 2035: Strategic trends and implications of new technologies](http://orfe.princeton.edu/%7Ealaink/SmartDrivingCars/PDFs/BrookingsLocalGovImplications.pdf)
...
Now, some companies are devising ways to help people profit from their vehicles. Startups like [RelayRides](https://relayrides.com/) and [Getaround](https://www.getaround.com/) help people rent out their cars during down time. Uber, Lyft and Sidecar connect car owners with people willing to pay for a ride. The rapid growth of these startups is transforming transportation — making it easier than ever before to get around without owning a car — and forcing automakers to devise new strategies to lure prospective buyers.

In June, [Ford launched a car-sharing program](http://www.geekwire.com/2015/ford-to-test-airbnb-for-cars-program-in-six-cities-including-portland/) that offers buyers a new way to offset the pains of ownership by tapping into what is essentially an Airbnb on wheels..." [Read more](http://www.detroitnews.com/story/business/autos/2015/07/11/ride-sharing-forces-automakers-rethink-sell/30023417/) Hmmmm... Very interesting. Alain

### [Remembering When Driverless Elevators Drew Skepticism](http://www.npr.org/2015/07/31/427990392/remembering-when-driverless-elevators-drew-skepticism)

S. Henn July 31 "These days, the idea of a driverless car makes a lot of people nervous. Our Planet Money team goes back in time when automatic elevators made people just as worried." [Listen](http://www.npr.org/2015/07/31/427990392/remembering-when-driverless-elevators-drew-skepticism) Hmmm... While autonomous taxis are much more difficult technically, the operational mode and service and economic advantages are thought worthy. I use repeatedly the elevator analogy when I talk about autonomous taxi service, cost and operational concepts. Alain

[The surprising fit between road pricing and the robotic vehicle](http://endofdriving.org/2015/06/30/the-surprising-fit-between-road-pricing-and-the-robotic-vehicle/)

June 30 "Seventeen years after Singapore installed its electronic road pricing system, twelve years after the London Congestion Charge was implemented, ten years after Germany began tolling trucks on its highways, eight years after Stockholm installed its congestion charging system, and even after several other countries and cities have installed successful, effective, wide-area congestion pricing systems for cars or trucks or both, America still has none.... [Read more](http://endofdriving.org/2015/06/30/the-surprising-fit-between-road-pricing-and-the-robotic-vehicle/)

### [Autonomous Vehicles: Energy & Policy Discussion](http://maniv.com/)

July 20 Two interesting set of slides from a private discussion with forward-thinking policymakers and technology leaders as we explore pressing questions and emerging challenges in the autonomous vehicle space. "[Larry Burns](http://orfe.princeton.edu/%7Ealaink/SmartDrivingCars/PDFs/Larry_Burns_TransformingMobility.072015.pdf) & [Brian Johnson](http://orfe.princeton.edu/%7Ealaink/SmartDrivingCars/PDFs/Brian_Johnson_DisruptiveMobility.072015.pdf) [Alain](http://orfe.princeton.edu/%7Ealaink/SmartDrivingCars/PDFs/Brian_Johnson_DisruptiveMobility.072015.pdf)

## Half-baked stuff that probably doesn't deserve your time:

### [Latest weapon to fight distracted driving: virtual reality](http://www.usatoday.com/story/tech/columnist/baig/2015/07/17/att-itcanwait-virtual-reality-campaign/30238301/)

E Baig July 17 "AT&T is counting on virtual reality to help reduce the number of potentially fatal automobile accidents. The wireless carrier is letting you take the wheel of a car virtually to simulate what can happen the instant you turn your attention away from the road to respond to a beeping cell phone or to text...." [Read more](http://www.usatoday.com/story/tech/columnist/baig/2015/07/17/att-itcanwait-virtual-reality-campaign/30238301/) Hmmm.. Should have put this in C'Mon Man! Please AT&T it is your devices that are the cause of the problem. Either automate the car or stop distracting us with your wireless services while we are supposed to be driving!! Alain

[Evaluating Technologies Relevant to the Enhancement of Driver Safe](http://orfe.princeton.edu/%7Ealaink/SmartDrivingCars/PDFs/EvaluatingVehicleSafetyTechsFINAL_AAA_Foundation.pdf) 2014 "...A total of seven technologies have been reviewed – two reference technologies (Electronic Stability Control and Adaptive Cruise Control) and five emergent safety technologies (Adaptive Headlights, Back-Up Cameras, Forward Collision Warning, Forward Collision Mitigation, and Lane Departure Warning). A major finding of the project has been that only relatively limited data is available upon which to objectively rate the real-world performance of most of these safety systems. A number of experts and industry representatives expressed some surprise at both the divergence between theoretical and observed benefit and the relative scarcity of data upon which to make objective assessments, while others were quite aware of these issues and the need for the development of objective data on real-world performance. This undertaking appears to have already succeeded in one of its goals by stimulating substantive constructive discussion and engagement within the research and industry based safety communities.... [Read more](http://orfe.princeton.edu/%7Ealaink/SmartDrivingCars/PDFs/EvaluatingVehicleSafetyTechsFINAL_AAA_Foundation.pdf) Hmmm... Still very worth reading; however, NHTSA and US DoT are moving very slowly. Alain

## [C'mon Man!](https://www.youtube.com/watch?v=A7SwSd59E4I) (These folks didn't get/read the memo)

### [Automakers try integrated tablets to retain backseat business](http://www.autonews.com/article/20150726/OEM06/307279987/automakers-try-integrated-tablets-to-retain-backseat-business)

J Chan July 26 "... However, they also tap into a car's electronics, allowing a passenger to assist the driver by programming a destination into the car's onboard navigation system. BMW's tablet lets a sleepy passenger close all the window shades by pressing one button..." [Read more](http://www.autonews.com/article/20150726/OEM06/307279987/automakers-try-integrated-tablets-to-retain-backseat-business) Hmmm... If these innovations were really only for passengers (even though cars rarely have passengers) then this might not be in C'Mon Man. The manufacturers should be fully using their talents to make everyone in the car a passenger, then these systems will really have an appeal and won't contribute to highway carnage. Alain
...
[November 4-9, 2015](http://www.podcarcity.org/siliconvalley)
